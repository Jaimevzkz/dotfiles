...
class PlayerManager:
    ...
    def show_fallback_icon(self):
        """Show fallback icon when no player is available or playing."""
        fallback_icon = "󰝛 " 
        self.write_output(fallback_icon, None)
    ...
    def on_player_appeared(self, _, player):
        ...
        if player.name in self.excluded_player:
            logger.debug("New player appeared, but it's in exclude list, skipping")
            return
